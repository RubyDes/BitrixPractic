				...
				<div class="row gy-4">
					...
					<div class="col-lg-4">
						<article>
							...
							<h2 class="title">
								<a href="#">Подробный разбор нашего успешного проекта: от идеи до реализации. Узнайте,
									как мы справились с вызовами и достигли результатов</a>
							</h2>
							<div class="d-flex align-items-center">
								<div class="post-meta">
									<p class="post-date">
					...
					<div class="col-lg-4">
						<article>
							...
							<h2 class="title">
								<a href="#">Как оптимизировать управление проектами в промышленности? Делимся советами
									по планированию и мониторингу.</a>
							</h2>
							<div class="d-flex align-items-center">
								<div class="post-meta">
									<p class="post-date">

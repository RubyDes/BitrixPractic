    ...
    <div class="container">
        <div class="row gy-4">
            ...
            <div class="col-lg-6 content">
                ...
                <p class="fst-italic">В современном мире промышленные предприятия сталкиваются с множеством вызовов, связанных с эффективностью и надежностью производственных процессов. Наша компания предлагает передовые инженерные решения, которые помогут вам справиться с этими задачами.</p>
                <ul>
                ...
                <p>Мы уверены, что наши решения помогут вам достичь новых высот в производительности и эффективности. Свяжитесь с нами, чтобы узнать больше о том, как мы можем помочь вашему бизнесу.</p>
            </div>
        </div>
    </div>
</section>